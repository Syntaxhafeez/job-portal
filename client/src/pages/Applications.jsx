...
const Applications = () => {
  ...
  const { backendUrl, userData, userApplications, fetchUserData, fetchUsersApplications } = useContext(AppContext)
            ...
            {userApplications.map((job, index) => true ? (
              <tr key={index}>
                <td className='py-3 px-4 flex items-center gap-2 border-b'>
                  <img className='w-8 h-8' src={job.companyId.image} />{job.companyId.name}</td>
